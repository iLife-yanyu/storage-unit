...
import com.yanyu.javalibs.storageunit.StorageName
...
class BootActivity : AppCompatActivity() {
    ...
    private fun updateResultAdapter() {
        ...
        val storage1000Impl = Storage1000Impl.get(storageName)
        val storage1024Impl = Storage1024Impl.get(storageName)
